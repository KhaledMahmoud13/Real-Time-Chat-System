...
import static com.khaled.realtimechatsystem.exception.ErrorCode.INVALID_TOKEN;
import static com.khaled.realtimechatsystem.exception.ErrorCode.TOKEN_EXPIRED;
...
public class JwtService {
    ...
    public boolean isTokeValid(final String token, final String expectedUsername) {
